...
\TLV
   ...
   |cpu
      @0
         ...
         $imem_rd_addr[31:0] = $imem_rd_en? $pc[M4_IMEM_INDEX_CNT+1:2]:0;
         //$imem_rd_data[31:0] = $imem_rd_en? $pc:0;
      ...
      @1
         ...
         $imm[31:0] = $is_i_instr? {{21{$instr[31]}},{$instr[30:20]}} :
                      ...
                      $is_j_instr? {{12{$instr[31]}},{$instr[19:12]},{$instr[20]},{$instr[30:25]},{$instr[24:21]},1'b0}:'0;
         ...
         `BOGUS_USE($is_add $is_addi $is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu) //wont show warning in log
         ...
         $result[31:0] = $is_addi? $src1_value[31:0] + $imm[31:0]:
                         $is_add? $src1_value[31:0] + $src2_value[31:0]: 32'b0;
         //write
